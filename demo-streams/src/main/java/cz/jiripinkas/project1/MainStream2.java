...
public class MainStream2 {
    ...
    public static void main(String[] args) {
        ...
        streamsConfiguration.put(StreamsConfig.APPLICATION_ID_CONFIG, "stream-sensor-B-application"); // tohle je jako group.id
        streamsConfiguration.put(StreamsConfig.CLIENT_ID_CONFIG, "stream-sensor-B-client");
